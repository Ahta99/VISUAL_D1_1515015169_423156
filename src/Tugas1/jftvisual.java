 ...
 * @author Acer
 */
public class jftvisual extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jftvisual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
